...
from bernstein_flow.Propagate import propagate_gpgmm_ekf, propagatate_gpgmm_wsasos
...
if __name__ == "__main__":
    ...
    for k in range(1, timesteps):
        p_curr = propagatate_gpgmm_wsasos(density_gmms_wsasos[k-1], transition_model)
