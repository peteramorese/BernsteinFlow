...
def run_trials_sos(train_data, test_data, save_directory, num_trials, gdt, n, 
    ...
    while trial < num_trials:
        ...
        try:
            ...
            print("Number of transition model parameters: ", transition_model.n_parameters())
        ...
        if save_figures:
            ...
            plot_2d_marginals_over_time(beliefs, (0, 1), "px_py",
                                        ...
                                        show_plot=False)
            plot_2d_marginals_over_time(beliefs, (3, 5), "vx_vz",
                                        resolution=60,
                                        save_path=os.path.join(save_directory, "marginals_vx_vz.png"),
                                        show_plot=False)
            ...
            plot_2d_marginals_over_time(beliefs, (3, 5), "vx_vz",
                                        resolution=60,
                                        save_path=os.path.join(sep_figs_save_directory, "marginals_vx_vz.png"),
                                        save_separate=True,
                                        show_titles=False,
                                        show_axes_labels=False,
                                        show_plot=False)
...
if __name__ == "__main__":
    ...
    plot_2d_particle_scatter_over_time(u_traj_data_test, (0, 1), "px_py_particles",
                                       ...
                                       show_plot=False)
    plot_2d_particle_scatter_over_time(u_traj_data_test, (3, 5), "vx_vz_particles",
                                       sample_limit=10000,
                                       save_path="figures/final_figs_12D/mc_particles_vx_vz.png",
                                       show_plot=False)
    ...
    plot_2d_particle_scatter_over_time(u_traj_data_test, (3, 5), "vx_vz_particles",
                                       sample_limit=10000,
                                       save_path="figures/final_figs_12D/separate_particles/mc_particles_vx_vz.png",
                                       save_separate=True,
                                       show_titles=False,
                                       show_axes_labels=False,
                                       show_plot=False)
